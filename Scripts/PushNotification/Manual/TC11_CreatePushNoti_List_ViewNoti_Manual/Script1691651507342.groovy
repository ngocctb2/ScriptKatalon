...
//VerifyViewNotification
String Number2Device = WebUI.getText(findTestObject('Object Repository/PushNotificationPage/TabManual/Both2Device'))
...
WebUI.verifyEqual(findTestObject(" (" + 'Object Repository/PushNotificationPage/TabManual/Both2Device_Expected'+ " devices)"), Number2Device)
