...
WebUI.click(findTestObject('Object Repository/PushNotificationPage/TabManual/NotiNavigateToProduct'))
Thread.sleep(1000)
WebUI.click(findTestObject('Object Repository/PushNotificationPage/TabManual/FieldProduct'))
Thread.sleep(1000)
WebUI.click(findTestObject('Object Repository/PushNotificationPage/TabManual/SelectProduct'))
...
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/PushNotificationPage/TabManual/title_Noti1')), 'Flash sale 80%', true)
WebUI.verifyMatch(WebUI.getText(findTestObject('Object Repository/PushNotificationPage/TabManual/message_Noti1')), 'STARTS NOW 80% OFF EVERYTHING!', true)
