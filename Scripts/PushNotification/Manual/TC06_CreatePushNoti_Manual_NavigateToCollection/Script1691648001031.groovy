...
WebUI.click(findTestObject('Object Repository/PushNotificationPage/TabManual/NotiNavigateTo_Collection'))
Thread.sleep(1000)
WebUI.click(findTestObject('Object Repository/PushNotificationPage/TabManual/FieldCollection'))
Thread.sleep(1000)
WebUI.click(findTestObject('Object Repository/PushNotificationPage/TabManual/SelectCollection'))
