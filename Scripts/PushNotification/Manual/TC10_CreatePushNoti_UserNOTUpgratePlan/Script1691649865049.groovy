...
//CheckUserUpgratedPlanWhenCreateNotification
if (WebUI.verifyElementPresent('Upgrade to send push notifications', 0)) {
	
    WebUI.verifyEqual(findTestObject('Object Repository/PushNotificationPage/TabManual/titleUpgratePlan'), 'Upgrade to send push notifications')
    WebUI.verifyEqual(findTestObject('Object Repository/PushNotificationPage/TabManual/TextUpgratePlan'), 'To send push notifications and keep your customers engaged, you need to upgrade to a higher subscription plan.')
    WebUI.verifyEqual(findTestObject('Object Repository/PushNotificationPage/TabManual/ButtonCancel'), 'Cancel')
    Thread.sleep(1000)

    try {
        WebUI.click(findTestObject('Object Repository/PushNotificationPage/TabManual/buttonViewPlans'))
        Thread.sleep(1000)
    }
    catch (Exception e) {
        println('Đã upgrade lên Starter')}} 
else {
    System.out.println('Upgrated Plan')}
