...
WebUI.refresh()
WebUI.click(findTestObject('Object Repository/HomePageShopify/select_Menu'))
...
//WebUI.setEncryptedText(findTestObject('Object Repository/LoginPage/input_Password'), 'vNm3ViMiYWhe46satoPgBg==')
